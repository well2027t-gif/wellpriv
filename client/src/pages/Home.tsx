...
/**
 * Well Privé - Layout Azul Telegram Simplificado
 * Foco em Welington R. e Card VIP
 */
    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      {particles.map((p) => (
        <motion.div
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: [0, 0.4, 0.15, 0], y: [0, -80, -150], x: [0, Math.random() * 30 - 15] }}
...
function AnimatedBackgroundGrid() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(0,136,204,0.03)_25%,rgba(0,136,204,0.03)_50%,transparent_50%,transparent_75%,rgba(0,136,204,0.03)_75%,rgba(0,136,204,0.03))] bg-[length:60px_60px] animate-pulse" />
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[rgba(0,136,204,0.05)]" />
    </div>
  );
}
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-black overflow-hidden">
      ...
      {/* Gradient orbs (Azul) */}
      <div className="absolute -top-40 -left-40 w-80 h-80 bg-[#0088CC]/20 rounded-full blur-3xl opacity-30 animate-pulse" />
      <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-[#1DA1F2]/10 rounded-full blur-3xl opacity-20 animate-pulse" style={{ animationDelay: "1s" }} />
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-[#0088CC] to-[#1DA1F2] rounded-3xl blur-3xl opacity-60" />
              <img
                src="/profile.jpeg"
                alt="Welington R."
                className="relative h-40 w-40 rounded-3xl object-cover border-4 border-[#0088CC] shadow-2xl"
              />
            </motion.div>
            ...
            <motion.div
              ...
              className="flex items-center gap-2 rounded-full border border-[#0088CC]/30 bg-gradient-to-r from-[#0088CC]/10 to-[#1DA1F2]/5 px-4 py-2 backdrop-blur-xl shadow-lg"
              style={{ boxShadow: "0 8px 32px rgba(0, 136, 204, 0.15)" }}
            >
              <span className="text-xs font-semibold text-white/80" style={{ fontFamily: "'Inter', sans-serif" }}>
                {count === null ? (
                  ...
                  <span>
                    👁️ <span className="font-bold text-[#0088CC]">{count.toLocaleString("pt-BR")}</span> visualizações
                  </span>
                )}
              </span>
            </motion.div>
          ...
          {/* TELEGRAM VIP Card - ÚNICO ELEMENTO INTERATIVO */}
          <motion.a
          ...
          >
            ...
            {/* Badge VIP */}
            <motion.div className="relative -mt-2 flex items-center gap-1.5 rounded-full bg-[#0088CC]/25 px-3 py-1">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white transition-colors duration-300 group-hover:text-[#0088CC]" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  Acesse o Grupo VIP
                </h3>
          ...
          {/* Informações de Pagamento - APENAS TEXTO */}
          <motion.div variants={textVariants} className="space-y-3 text-center">
            <p className="text-sm text-white/80" style={{ fontFamily: "'Inter', sans-serif" }}>
              Para ter acesso ao grupo:
            </p>
            <p className="text-2xl font-bold text-[#0088CC]" style={{ fontFamily: "'Poppins', sans-serif" }}>
              R$ 10 via Pix
            </p>
            ...
            <div className="border-t border-white/10 pt-3">
              <p className="text-[9px] text-white/30 tracking-widest uppercase" style={{ fontFamily: "'Inter', sans-serif" }}>
